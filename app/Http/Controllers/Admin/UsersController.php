...
class UsersController extends Controller
{
    ...
    public function create()
    {
		...
		$circles =ForestState::pluck('name_bn', 'id')->prepend(trans('global.pleaseSelect'), '');
		
		$divisions = ForestDivision::pluck('name_bn', 'id')->prepend(trans('global.pleaseSelect'), '');



        $roles = Role::pluck('title', 'id');

        return view('admin.users.create', compact('designations', 'roles','circles','divisions'));
    }
