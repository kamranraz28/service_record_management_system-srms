    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.batches.update", [$batch->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('batch_bn') ? 'is-invalid' : '' }}" type="text" name="batch_bn" id="batch_bn" value="{{ old('batch_bn', $batch->batch_bn) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('batch_en') ? 'is-invalid' : '' }}" type="text" name="batch_en" id="batch_en" value="{{ old('batch_en', $batch->batch_en) }}" required>
