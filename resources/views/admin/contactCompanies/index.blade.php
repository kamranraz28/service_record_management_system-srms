    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table-bordered table-striped table-hover datatable datatable-ContactCompany table">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <tr data-entry-id="{{ $contactCompany->id }}">
                                ...
                                <td>
                                    ...
                                    @can('contact_company_delete')
                                        <form action="{{ route('admin.contact-companies.destroy', $contactCompany->id) }}"
