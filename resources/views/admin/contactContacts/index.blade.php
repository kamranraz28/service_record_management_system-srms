    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table-bordered table-striped table-hover datatable datatable-ContactContact table">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <tr data-entry-id="{{ $contactContact->id }}">
                                ...
                                <td>
                                    ...
                                    @can('contact_contact_delete')
                                        <form action="{{ route('admin.contact-contacts.destroy', $contactContact->id) }}"
