...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.forest-states.update', [$forestState->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name_bn') ? 'is-invalid' : '' }}" type="text"
                        name="name_bn" id="name_bn" value="{{ old('name_bn', $forestState->name_bn) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text"
                        name="name_en" id="name_en" value="{{ old('name_en', $forestState->name_en) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('bbs_code') ? 'is-invalid' : '' }}" type="text"
                        name="bbs_code" id="bbs_code" value="{{ old('bbs_code', $forestState->bbs_code) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select select2 {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status_id"
                        ...
                        @foreach ($statuses as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('status_id') ? old('status_id') : $forestState->status->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
