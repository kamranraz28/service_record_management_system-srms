...
@section('content')
    @can('division_create')
        <div style="margin-bottom: 10px;" class="row">
            ...
            @include('csvImport.modal', ['model' => 'Division', 'route' => 'admin.divisions.parseCsvImport'])
        --}}
            </div>
        </div>
    @endcan
    <div class="card">
        ...
        <div class="card-body">
            <table class="table-bordered table-striped table-hover ajaxTable datatable datatable-Division table">
                <thead>
                    <tr>
                        <th width="10">
