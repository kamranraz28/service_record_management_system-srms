        ...
        <div class="card-header">
            ...
            <br><strong class="text-dark classname">
                @if (app()->getLocale() === 'bn')
                    ...
                    {{ $educationInformatione->employee->fullname_bn }}
                    &nbsp;
                    {{ trans('cruds.employeeList.fields.employeeid') }}:{{ $educationInformatione->employee->employeeid }}
                @else
                    {{ trans('cruds.employeeList.fields.fullname_en') }}:
                    {{ $educationInformatione->employee->fullname_en }}
                    &nbsp;
                    {{ trans('cruds.employeeList.fields.employeeid') }}:{{ $educationInformatione->employee->employeeid }}
                @endif
            </strong>
            ...
            <form method="POST" action="{{ route('admin.education-informationes.update', [$educationInformatione->id]) }}"
                ...
                <div class="row row-cols-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('name_of_exam') ? 'is-invalid' : '' }}"
					...
					<div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('exam_degree') ? 'is-invalid' : '' }}"
									name="exam_degree" id="exam_degree" required>
								@foreach ($name_of_degrees as $id => $entry)
									<option value="{{ $id }}"
										{{ (old('exam_degree') ? old('exam_degree') : $educationInformatione->exam_degree) == $id ? 'selected' : '' }}>
										{{ $entry }}
									</option>
								@endforeach
							</select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('result') ? 'is-invalid' : '' }}"
					...
					<div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('cgpa') ? 'is-invalid' : '' }}" type="text"
                            name="cgpa" id="cgpa" value="{{ old('cgpa', $educationInformatione->cgpa) }}">
                        @if ($errors->has('cgpa'))
                            <div class="invalid-feedback">
                                {{ $errors->first('cgpa') }}
                            </div>
