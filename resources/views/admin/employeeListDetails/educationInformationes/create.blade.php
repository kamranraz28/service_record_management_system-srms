...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.educationInformatione.title_singular') }}
        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select select2 {{ $errors->has('result') ? 'is-invalid' : '' }}" name="result_id"
                        ...
                        @foreach ($results as $id => $entry)
                            <option value="{{ $id }}" {{ old('result_id') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select select2 {{ $errors->has('achievement_types') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($achievement_types as $id => $entry)
                            <option value="{{ $id }}"
                                {{ old('achievement_types_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
