				...
				{{--<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('fullname_bn') ? 'is-invalid' : '' }}" type="text"
                            name="fullname_bn" id="fullname_bn"
                            value="{{ old('fullname_bn', $employeeList->fullname_bn) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('fullname_en') ? 'is-invalid' : '' }}" type="text"
                            name="fullname_en" id="fullname_en"
                            value="{{ old('fullname_en', $employeeList->fullname_en) }}" required>
					...
					<div class="form-group">
                        ...
                        <select class="form-select select2 {{ $errors->has('designation') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($designations as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('designation_id') ? old('designation_id') : $employeeList->designation->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('prl_date') ? 'is-invalid' : '' }}"
                            type="text" name="prl_date" id="prl_date"
                            value="{{ old('prl_date', $employeeList->prl_date) }}" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('nid') ? 'is-invalid' : '' }}" type="number"
                            name="nid" id="nid" value="{{ old('nid', $employeeList->nid) }}" step="0.01">
                        @if ($errors->has('nid'))
                            <div class="invalid-feedback">
                                {{ $errors->first('nid') }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('projectrevenue') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($projectrevenues as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('joiningexaminfo_id') ? old('joiningexaminfo_id') : $employeeList->projectrevenue->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
					...
					<div class="form-group">
                        <label 
                            for="projectrevenue_id">রাজস্ব ভিন্নতা</label>
                        <select class="form-control select2 {{ $errors->has('projectrevenue_id') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($departmental_exams as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('projectrevenue_id') ? old('projectrevenue_id') : $employeeList->cadre->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
					...
					<div class="form-group">
                        <label
                            for="certificate_upload">পরীক্ষার সনদ /প্রজ্ঞাপন সংযোজন</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('project') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($projects as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('project_id') ? old('project_id') : $employeeList->project->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
					...
					<div class="form-group">
                        <label
                            for="date_of_regularization">নিয়মিত করনের আদেশ জারির তারিখ</label>
                    ...
                    <div class="form-group">
                        <label
                            for="regularization_office_orde_go">নিয়মিত করনের আদেশ সংযোজন</label>
					...
					<div class="form-group">
                        ...
                        <select class="form-select select2 {{ $errors->has('designation') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($designations as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('first_designation_id') ? old('first_designation_id') : $employeeList->designation->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
                        @if ($errors->has('designation'))
                    ...
                    <div class="form-group">
                        <label
                            for="first_joining_g_o_date">প্রথম নিয়োগের আদেশ/প্রজ্ঞাপন/স্মারক তারিখ</label>
                    ...
                    <div class="form-group">
                        <label
                            for="first_joining_memo_no">প্রথম নিয়োগের প্রজ্ঞাপন/আদেশ/স্মারক নম্বর</label>
                    ...
                    <div class="form-group">
                        <label
                            for="first_joining_order">প্রথম নিয়োগের প্রজ্ঞাপন/আদেশ/স্মারক সংযোজন</label>
                    ...
                    <div class="form-group">
                        <label
                            for="confirmation_in_service">স্থায়ীকরণের আদেশ সংযোজন</label>
					...
					<div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('freedomfighter') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($freedomfighters as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('freedomfighter_id') ? old('freedomfighter_id') : $employeeList->freedomfighter->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
