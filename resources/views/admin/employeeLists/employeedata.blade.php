        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                        ...
                        <div>
                            ...
                            <table class="table-bordered table-striped table" id="General">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            {{ trans('cruds.employeeList.fields.cadre/noncadre') }}
                                        </th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $employeeList->first_designation->name_bn ?? '' }},
                                    ...
                                    @if ($employeeList->project_id)
                                        <tr>
                                            ...
                                            <td>
                                                {{$employeeList->project_to_revenue_memo ?? 'N/A'}}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (app()->getLocale() === 'bn')
                                                    {{englishToBanglaNumber($employeeList->project_to_revenue_date ?? 'N/A')}}

                                                @else
                                                    {{$employeeList->project_to_revenue_date ?? 'N/A'}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($employeeList->ptr_upload)
                                                    <a href="{{ $employeeList->ptr_upload->getUrl() }}" target="_blank">
                                                        {{ trans('global.view_file') }}
                                                    </a>
                                                @else
                                                    N/A
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Delete button -->
                                                <form action="{{ route('admin.children.destroy', ['child' => $child->id]) }}"
                                                    method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger"
                                ...
                                <table class="table-bordered table-striped table" id="jobHistory">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($jobHistory->office_unit_id !== 3)
                                        ...
                                        @if ($jobHistory->office_unit_id === 3)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($jobHistory->other_institution)
                                                        {{ $jobHistory->other_institution }}
                                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($leaveRecord->leave_order)
                                                    <a href="{{ $leaveRecord->leave_order->getUrl() }}" target="_blank">
                                                        {{ trans('global.view_file') }}
                                                    </a>
                                                @endif
                                            </td>
                            ...
                            {{--<strong id="foreignTravelPersonal"> {{ trans('cruds.foreignTravelPersonal.title')
                                }}</strong>
                            <br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Delete button -->
                                            <form
                                                action="{{ route('admin.foreign-travel-personals.destroy', ['foreign_travel_personal' => $foreignTravelPersonal->id]) }}"
                                                method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-danger"
                                                    onclick="return confirm('আপনি নিশ্চিত এটা মুছে দিতে চান?');">{{
                                                    trans('global.delete') }}</button>
                                            </form>
                                        </td>
                                    </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Delete button -->
                                                <form="{{ route('admin.awards.destroy', ['award' => $award->id]) }}"
                                                    method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($criminalProsecutione->appeal_order)
                                                    <a href="{{ $criminalProsecutione->appeal_order->getUrl() }}" target="_blank">
                                                        {{ trans('global.view_file') }}
                                                    </a>
                                                @else
                                                    N/A
                            ...
                            @foreach ($employeeList->policeverifications ?? [] as $policeverification)
                                ...
                                <table class="table-bordered table-striped table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                @if($policeverification->verification_type == 1)
                                                    @if (app()->getLocale() === 'bn')
                                                        হ্যাঁ
                                                    @else
                                                        Yes
                            ...
                            @foreach ($employeeList->timescales ?? [] as $timescale)
                                ...
                                <table class="table-bordered table-striped table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (app()->getLocale() === 'bn')
                                                    {{englishToBanglaNumber($timescale->receipt_date) ?? ''}}
                                                @else
                                                    {{$timescale->receipt_date ?? ''}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($timescale->office_order)
                                                    <a href="{{ $timescale->office_order->getUrl() }}" target="_blank">
                                                        {{ trans('global.view_file') }}
                                                    </a>
                                                @else
                                                    N/A
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Edit button -->
                                                <a href="{{ route('admin.time-scale.edit', ['time_scale' => $timescale->id]) }}"
                                                    class="btn btn-sm btn-primary">{{ trans('global.edit') }}</a>


                                                <!-- Delete button -->
                                                <form
                                                    action="{{ route('admin.time-scale.destroy', ['time_scale' => $timescale->id]) }}"
                                                    method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger"
                            ...
                            @foreach ($employeeList->others ?? [] as $other)
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                @if ($other->health_paper)
                                                    <a href="{{ $other->health_paper->getUrl() }}" target="_blank">
                                                        {{ trans('global.view_file') }}
                                                    </a>
                                                @else
                                                    N/A
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Delete button -->
                                                <form action="{{ route('admin.other.destroy', ['other' => $other->id]) }}"
                                                    method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger"
                    ...
                    <br>
                    <br>
                    @if ($employeeList->updated_at)
                        <p class="text-muted text-center">
                            সর্বশেষ আপডেটের তারিখ ও সময়:
                            {{ englishToBanglaNumber($employeeList->updated_at->format('d-m-Y H:i:s')) }}
                        </p>
                    @endif
                </div>
