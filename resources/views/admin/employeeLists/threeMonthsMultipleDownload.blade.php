        ...
        <tr>
            ...
            <td style="text-align: center;" style="border: 0;">
                <center>
                    ...
                    <p>
                        বন বিভাগঃ {{$divisions['name_bn'] ?? ''}} <br>
                        জেলাঃ {{$districts['name_bn'] ?? ''}} <br>
                        পদবিঃ {{$designations['name_bn'] ?? ''}}
                    </p>
                    ...
                    <p>
                        Forest Division: {{$divisions['name_en'] ?? ''}} <br>
                        District: {{$districts['name_en'] ?? ''}} <br>
                        Description: {{$designations['name_en'] ?? ''}}
                    </p>
