    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table-bordered table-striped table-hover datatable datatable-FaqQuestion table">
                    <thead>
                        <tr>
                            <th width="10">
                                ...
                                <td>
                                    @can('faq_question_show')
                                        <a class="btn btn-sm btn-success px-2"
                                            href="{{ route('admin.faq-questions.show', $faqQuestion->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('faq_question_edit')
                                        <a class="btn btn-sm btn-warning px-2"
                                            href="{{ route('admin.faq-questions.edit', $faqQuestion->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('faq_question_delete')
                                        <form action="{{ route('admin.faq-questions.destroy', $faqQuestion->id) }}"
