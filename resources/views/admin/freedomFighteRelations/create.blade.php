...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.freedomFighteRelation.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.freedom-fighte-relations.store") }}" enctype="multipart/form-data">
            @csrf
