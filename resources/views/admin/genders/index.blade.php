...
@section('content')
    @can('gender_create')
        <div style="margin-bottom: 10px;" class="row">
            ...
            @include('csvImport.modal', ['model' => 'Gender', 'route' => 'admin.genders.parseCsvImport'])
         --}}
            </div>
        </div>
    @endcan
    <div class="card">
        ...
        <div class="card-body">
            <table class="table-bordered table-striped table-hover ajaxTable datatable datatable-Gender table">
                <thead>
                    <tr>
                        <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Gender').DataTable(dtOverrideGlobals);
