    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.grades.update", [$grade->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_bn') ? 'is-invalid' : '' }}" type="text" name="name_bn" id="name_bn" value="{{ old('name_bn', $grade->name_bn) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" id="name_en" value="{{ old('name_en', $grade->name_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salary_range') ? 'is-invalid' : '' }}" type="text" name="salary_range" id="salary_range" value="{{ old('salary_range', $grade->salary_range) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_basic_pay') ? 'is-invalid' : '' }}" type="text" name="current_basic_pay" id="current_basic_pay" value="{{ old('current_basic_pay', $grade->current_basic_pay) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('basic_pay_scale') ? 'is-invalid' : '' }}" type="text" name="basic_pay_scale" id="basic_pay_scale" value="{{ old('basic_pay_scale', $grade->basic_pay_scale) }}" required>
