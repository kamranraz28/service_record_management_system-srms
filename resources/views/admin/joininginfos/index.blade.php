...
@section('content')
@can('joininginfo_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.joininginfos.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.joininginfo.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.joininginfo.title_singular') }} {{ trans('global.list') }}
    </div>
        ...
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Joininginfo">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.joininginfo.fields.project_revenue_en') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
@can('joininginfo_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.joininginfos.massDestroy') }}",
