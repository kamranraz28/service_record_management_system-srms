...
@section('content')
    @can('leave_type_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.leave-types.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.leaveType.title_singular') }}
                </a>
                {{-- <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                {{ trans('global.app_csvImport') }}
            </button>
            @include('csvImport.modal', ['model' => 'LeaveType', 'route' => 'admin.leave-types.parseCsvImport'])
        --}}
            </div>
        </div>
    @endcan
    <div class="card">
        ...
        <div class="card-body">
            <table class="table-bordered table-striped table-hover ajaxTable datatable datatable-LeaveType table">
                <thead>
                    <tr>
                        <th width="10">
