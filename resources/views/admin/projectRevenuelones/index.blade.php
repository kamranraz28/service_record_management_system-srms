...
@section('content')
@can('project_revenuelone_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.project-revenuelones.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.projectRevenuelone.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.projectRevenuelone.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('project_revenuelone_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.project-revenuelones.massDestroy') }}",
