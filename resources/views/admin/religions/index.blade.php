...
@section('content')
    @can('religion_create')
        <div style="margin-bottom: 10px;" class="row">
            ...
            @include('csvImport.modal', ['model' => 'Religion', 'route' => 'admin.religions.parseCsvImport']) --}}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table-bordered table-striped table-hover ajaxTable datatable datatable-Religion table">
                <thead>
                    <tr>
                        <th width="10">
