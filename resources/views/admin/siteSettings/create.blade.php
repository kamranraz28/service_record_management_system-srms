    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.site-settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('copyright') ? 'is-invalid' : '' }}" type="text" name="copyright" id="copyright" value="{{ old('copyright', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('helpline') ? 'is-invalid' : '' }}" type="text" name="helpline" id="helpline" value="{{ old('helpline', '') }}">
