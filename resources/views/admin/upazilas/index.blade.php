...
@section('content')
    @can('upazila_create')
        <div style="margin-bottom: 10px;" class="row">
            ...
            @include('csvImport.modal', ['model' => 'Upazila', 'route' => 'admin.upazilas.parseCsvImport'])
        --}}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table-bordered table-striped table-hover ajaxTable datatable datatable-Upazila table">
                <thead>
                    <tr>
                        <th width="10">
